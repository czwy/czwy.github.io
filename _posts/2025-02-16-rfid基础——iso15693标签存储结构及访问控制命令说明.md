...
last_modified_at: 2025-02-28 09:57:21 +0800
mtime: 2025-02-28 09:57:21
tags:
- RFID
- ISO15693
...
!<a href="/posts/iso-15693标签存储区说明-f04f63/">ISO 15693标签存储区说明#^f04f63</a>
!<a href="/posts/iso-15693标签存储区说明-block-4-block-3/">ISO 15693标签存储区说明#Block -4 & Block -3</a>
!<a href="/posts/iso-15693标签存储区说明-block-2/">ISO 15693标签存储区说明#Block -2</a>
!<a href="/posts/iso-15693标签存储区说明-block-1/">ISO 15693标签存储区说明#Block -1</a>
## 传输协议
...
![ISO15693Response_Flags_Description](https://eb19df4.webp.li/2025/02/ISO15693Response_InfoFlags_Description.png)
#### 响应错误码
...
上述示例中，响应的信息标志为 `0x0F`，表示 DSFID 、 AFI、VICC内存容量、IC参考都会在结果中显示。其中信息域中VICC内存容量的值为`1B 03`，由于<a href="/posts/rfid基础-iso15693标签存储结构及访问控制命令说明-传输协议-传输协议/">RFID基础——ISO15693标签存储结构及访问控制命令说明#传输协议|传输协议</a>中定义了!<a href="/posts/rfid基础-iso15693标签存储结构及访问控制命令说明-abadd7/">RFID基础——ISO15693标签存储结构及访问控制命令说明#^abadd7</a>，因此 `1B` 是表示有27个数据块，`03` 表示每块4个字节。
